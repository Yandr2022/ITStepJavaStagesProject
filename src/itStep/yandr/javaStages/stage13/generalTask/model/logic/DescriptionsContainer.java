...
public class DescriptionsContainer {
    ...
    public static final String[] COMMAND_NAMES = {NAME_DEFINE_MIN_VALUE, NAME_DEFINE_MAX_VALUE, NAME_CALCULATE_AVERAGE
            ,  NAME_SUM_MODULES_ARE_LESS_THAN_AVERAGE, NAME_MULTIPLYING_POSITIVE_NUMBERS_TO_RIGHT_PLACES
            , NAME_SWAP_EXTREME_VALUES, NAME_SELECT_ALL_ACTION};
    public static final String[] DESCRIPTION_OF_METHODS = {DESCRIPTION_OF_METHOD_TO_FIND_MIN_VALUE
            , DESCRIPTION_OF_METHOD_TO_FIND_MAX_VALUE, DESCRIPTION_OF_METHOD_TO_CALCULATE_AVERAGE
            ...
            , "Get the results of executing all available functionality"};
}
