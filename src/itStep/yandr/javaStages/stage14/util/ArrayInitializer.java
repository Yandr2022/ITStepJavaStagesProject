...
import static itStep.yandr.javaStages.stage14.util.DataValidator.validateArray;
import static itStep.yandr.javaStages.stage14.util.InputManager.getInt;
import static itStep.yandr.javaStages.stage14.util.InputManager.getStringWithLetter;
...
public class ArrayInitializer {
    ...
    public static void userInit(double[] array, String msg) throws InvalidSizeOfArrayException {
        ...
        Printer.print(msg);
        for (int i = 0; i < array.length; i++) {
            array[i] = itStep.yandr.javaStages.stage13.util.InputManager.getDouble();
        }
    }
...
//        } else {
//            Printer.printError(MSG_INVALID_KEYWORD);
//            fillArrayWithSelectTypeInitWithControllingBounds(array, boundMin, boundMax);
//        }
//    }
//
